...
public class CustomerOrderController {
    ...
    public CustomerOrderController(CustomUserDetailsService customUserDetailsService, OrderRepository orderRepository, OrderStatusRepository orderStatusRepository, ProductRepository productRepository, CategoryRepository categoryRepository, ShopRepository shopRepository) {
    ...
    public String viewOrder(Model model) {
        ...
        List<Order> orders = orderRepository.findByBuyerID(user.getUserID());
