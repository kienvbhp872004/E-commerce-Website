...
public class AdminReviewController {
        ...
        public AdminReviewController(CustomUserDetailsService customUserDetailsService, ShopRepository shopRepository, OrderRepository orderRepository, ProductRepository productRepository, ReviewRepository reviewRepository) {
    ...
    public String deleteReview(@PathVariable("id") int id){
            ...
            reviewRepository.deleteById(longValue);
